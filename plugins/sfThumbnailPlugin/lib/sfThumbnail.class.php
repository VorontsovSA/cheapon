...
class sfThumbnail
{
   ...
   */
  public function __construct($maxWidth = null, $maxHeight = null, $scale = true, $inflate = true, $quality = 75, $crop = false, $adapterClass = null, $adapterOptions = array())
  {
    if (!$adapterClass)
    {
    ...
    $this->adapter = new $adapterClass($maxWidth, $maxHeight, $scale, $inflate, $crop, $quality, $adapterOptions);
  }
  ...
  */
   ...
   * Used by adapter
   */
  public function initThumb($sourceWidth, $sourceHeight, $maxWidth, $maxHeight, $scale, $inflate, $crop)
  {
    //print 'LALA1<br>';
    if ($maxWidth > 0)
    {
