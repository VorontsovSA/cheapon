 ...
 */
class sfValidatedThumbnailFile extends sfValidatedFile
{
  protected
    $width        = 0,
    $height       = 0,
  ...
  public function setThumbnailProperties($width, $height, $crop = false)
  {
    $this->width = $width;
    $this->height = $height;
    $this->crop = $crop;
  ...
  public function save($file = null, $fileMode = 0666, $create = true, $dirMode = 0777)
  {
    ...
    $thumb = new sfThumbnail($this->width, $this->height, true, false, 100, $this->crop);
